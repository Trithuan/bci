...
class MyPlotClass():
	...
	def __init__(self, dataClass):
		...
		self.ax0 = plt.subplot2grid((14,1), (0, 0), rowspan=1)
		self.ax1 = plt.subplot2grid((14,1), (1, 0), rowspan=1)
		self.ax2 = plt.subplot2grid((14,1), (2, 0), rowspan=1)
		self.ax3 = plt.subplot2grid((14,1), (3, 0), rowspan=1)
		self.ax4 = plt.subplot2grid((14,1), (4, 0), rowspan=1)
		self.ax5 = plt.subplot2grid((14,1), (5, 0), rowspan=1)
		self.ax6 = plt.subplot2grid((14,1), (6, 0), rowspan=1)
		self.ax7 = plt.subplot2grid((14,1), (7, 0), rowspan=1)
		self.ax8 = plt.subplot2grid((14,1), (8, 0), rowspan=1)
		self.ax9 = plt.subplot2grid((14,1), (9, 0), rowspan=1)
		self.ax10 = plt.subplot2grid((14,1), (10, 0), rowspan=1)
		self.ax11 = plt.subplot2grid((14,1), (11, 0), rowspan=1)
		self.ax12 = plt.subplot2grid((14,1), (12, 0), rowspan=1)
		self.ax13 = plt.subplot2grid((14,1), (13, 0), rowspan=1)
	...
	def run(self):
		...
		while True:
			...
			if 'eeg' in flux.keys():
				...
				if len(self._dataClass.XData) > 1000:
